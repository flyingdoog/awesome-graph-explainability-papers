...
9. [Arxiv 25.01] **Watermarking Graph Neural Networks via Explanations for Ownership Protection** [[paper]](https://arxiv.org/abs/2501.05614)
10. [Arxiv 25.01] **Mixture-of-Experts Graph Transformers for Interpretable Particle Collision Detection** [[paper]](https://arxiv.org/abs/2501.03432)
11. [ACM Computing Surveys] **Can Graph Neural Networks be Adequately Explained? A Survey** [[paper]](https://dl.acm.org/doi/abs/10.1145/3711122)
12. [IEEE TNSRE] **Finding Neural Biomarkers for Motor Learning and Rehabilitation using an Explainable Graph Neural Network** [[paper]](https://ieeexplore.ieee.org/abstract/document/10843258)
13. [Springer FCS] **Learning from shortcut: a shortcut-guided approach for explainable graph learning** [[paper]](https://link.springer.com/article/10.1007/s11704-024-40452-4)
14. [NN] **Local interpretable spammer detection model with multi-head graph channel attention network** [[paper]](https://www.sciencedirect.com/science/article/pii/S0893608024009985)
15. [ Applied Intelligence ] **KnowGNN: a knowledge-aware and structure-sensitive model-level explainer for graph neural networks** [[paper]](https://link.springer.com/article/10.1007/s10489-024-06034-4)
